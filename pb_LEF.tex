...
\paragraph{Watts-Strogatz} Results for Watts-Strogatz instances with $m = 2$ are shown at Figure~\ref{fig:runtime-watts-strogatz-2}.

\begin{figure}[htb]
\centering
\includegraphics[width=0.5\linewidth]{results-runtime-WS-2.png}
\caption{Average Runtime for DEC-LEF on Watts-Strogatz Social Networks for $m=2$ and $n \in \{10,20,30,40,50\}$\label{fig:runtime-watts-strogatz-2}}
\end{figure}
